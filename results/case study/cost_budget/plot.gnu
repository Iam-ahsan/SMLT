...
set output 'Bert_medium_time_cost_budget.pdf'
...
plot source1 using ($2)/120:key(1) ti col, 'plot_data_cirus' using ($2)/60 ti col , 'plot_data_Siren' using ($2)/60 ti col#, '' using ($5)/1000 ti col, '' using ($6)/1000 ti col#, '' using($7)/1000 ti col#, '' using ($8)/1000 ti col#, source2 using 2 ti "" with linespoints ls 1 pt 5 ps 0.45 lc rgb "black"
