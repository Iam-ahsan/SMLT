...
set output 'Bert_L2_strawman_S3_train.pdf'
set boxwidth 0.9 absolute
set style fill   solid 1.00 border lt -1
set key fixed right top vertical Left noreverse noenhanced autotitle nobox
set key inside  left top maxrows 2 center reverse samplen 0.05 width 0
...
set yrange [ 0.00000 : 45 ] noreverse writeback
set ytics 0,20,40
