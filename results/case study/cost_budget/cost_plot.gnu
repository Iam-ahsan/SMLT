...
set output 'Bert_medium_cost_time_budget.pdf'
...
set key inside Left top maxrows 1 left reverse samplen 0.1 width 0
...
#set arrow from -1,3600 to 3, 3600 nohead front lc rgb "black" lw 1  dashtype "-"
set arrow from -1,50 to 3, 50 nohead front lc rgb "black" lw 1  dashtype "-"

plot source1 using ($3):key(1) ti col, 'plot_data_cirus' using ($3) ti col , 'plot_data_Siren' using ($3) ti col#, '' using ($5)/1000 ti col, '' using ($6)/1000 ti col#, '' using($7)/1000 ti col#, '' using ($8)/1000 ti col#, source2 using 2 ti "" with linespoints ls 1 pt 5 ps 0.45 lc rgb "black"
