...
set output 'Bert_medium_Resnet50_sharded_cluster_5_comm_Siren.pdf'
source1='plot_data'
...
plot source1 using ($2)/1000 ti col, '' using ($3)/1000:key(1) ti col , '' using ($4)/1000 ti col, '' using ($5)/1000 ti col, '' using ($6)/1000 ti col#, '' using($7)/1000 ti col#, '' using ($8)/1000 ti col#, source2 using 2 ti "" with linespoints ls 1 pt 5 ps 0.45 lc rgb "black"
