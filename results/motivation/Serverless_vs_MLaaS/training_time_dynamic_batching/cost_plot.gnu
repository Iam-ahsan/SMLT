...
set output 'bert_L12_cost_compare.pdf'
...
set yrange [ 0.00000 : 35 ] noreverse writeback
set ytics 0,10,30
...
plot 'overall_data' using ($2)/1000:xtic(1) ti col, '' u ($3)/1000 ti col #, '' u 3 ti col#, '' u 4 ti col
