...
set output 'resnet50_comm_compare.pdf'
source1='data_SMLT'
source2='data_Siren'
...
set xrange [ 0 : 205 ] noreverse writeback
set x2range [ * : * ] noreverse writeback
set ylabel "time [sec]" font ',15'
set yrange [ 0.0 : 120.0]
set ytics 0,40,120
set xtics 0,50,200
#plot source1 using 1:($2)/1000 ti "4.xlarge" with linespoints ls 1 pt 5 ps 0.45 lc rgb "blue", source2 using 1:2 ti "12.xlarge" with linespoints ls 1 pt 5 ps 0.45 lc rgb "black", source3 using 1:2 ti "16.xlarge" with #linespoints ls 1 pt 5 ps 0.45 lc rgb "red"
...
plot source1 using 1:($2)/1000 ti "SMLT" with linespoints ls 1 pt 3 ps 0.45 lc rgb "black" ,\
  source2 using 1:($2)/1000 ti "Siren" with linespoints ls 1 pt 4 ps 0.45 lc rgb "red" ,\
 source3 using 1:($2)/1000 ti "Cirrus" with linespoints ls 1 pt 6 ps 0.45 lc rgb "blue" ,\
