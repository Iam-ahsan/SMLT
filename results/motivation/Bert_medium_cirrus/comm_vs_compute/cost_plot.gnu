...
set output 'Bert_L12_strawman_redis_cluister_3_train.pdf'
set boxwidth 0.9 absolute
set style fill   solid 1.00 border lt -1
set key fixed right top vertical Left noreverse noenhanced autotitle nobox
set key inside  right top maxrows 2 center reverse samplen 0.05 width 0
...
set yrange [ 0.00000 : 100] noreverse writeback
set ytics 0,50,100
...
plot 'overall_data' using (($2)+($3))/1000:xtic(1) ti col fs pattern 2, '' u ($4)/1000 ti col #, '' u 3 ti col#, '' u 4 ti col
