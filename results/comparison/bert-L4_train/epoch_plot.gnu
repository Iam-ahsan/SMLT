...
set output 'bert_L12_train_compare.pdf'
source1='data_SMLT'
source2='data_Siren'
...
plot source1 using 1:($2+$3)/1000 ti "SMLT" with linespoints ls 1 pt 3 ps 0.45 lc rgb "black" ,\
  source2 using 1:($2+$3)/1000 ti "Siren" with linespoints ls 1 pt 4 ps 0.45 lc rgb "red" ,\
 source3 using 1:($2+$3)/1000 ti "Cirrus" with linespoints ls 1 pt 6 ps 0.45 lc rgb "blue" ,\
