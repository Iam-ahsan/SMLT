...
def lambda_handler(event, context):
    ...
    model = bert_small.Train(worker_id,miniBatch_count, epoch_count+1, total_workers, training_indexes, num_shards)
    model.train_org()
    get_gradients('L2_grads.pkl', num_shards, worker_id) 
